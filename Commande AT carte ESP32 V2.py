...
def get_air_speed():
    # vitesse d'air avion simulée
    # plage réaliste pour un avion/drone : 0 → 250 km/h
...
while True:
    ...
    if lat and lon:
        ...
        air_speed = get_air_speed()

        payload = "{:.5f};{:.5f},{:.2f},{:.1f},{:.1f},{:.1f},{:.1f}".format(
            lat,
            lon,
            v1,
            temperature,
