...
class AssistController:
    ...
    # LIMITATION
    # =========================
    def __get_beginner_strength(self, channels):
        """
    ...
    def apply_limit(self, pulse, centre, channels):
        ...
        limit = self.__get_dynamic_limit(channels)
