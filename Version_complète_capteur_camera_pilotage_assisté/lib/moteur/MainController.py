...
from lib.capteurs.SensorManager import SensorManager
...
class MainController:
    ...
    def __init__(self, config):
        ...
        self.sensors = SensorManager(config["capteurs"], config["camera"])
    ...
    def __update_outputs_normal(self, channels):
        ...
        for i, (device, channel) in enumerate(self.devices):
            ...
            if channel == self.CH_THROTTLE:
                pulse = channels[channel]  # direct radio
                # CUT OFF THROTTLE
                if pulse < 1100:
                    pulse = 1000
    ...
    def run(self):
        ...
        while True:
            ...
            if is_failsafe:
                ...
                self.stabilizer.target_pitch = max(-10, self.stabilizer.target_pitch)
